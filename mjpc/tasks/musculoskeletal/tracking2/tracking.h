...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_TRACKING2_TASK_H_
#define MJPC_TASKS_MUSCULOSKELETAL_TRACKING2_TASK_H_
...
class Tracking2 : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Tracking2* task, int current_mode = 0,
