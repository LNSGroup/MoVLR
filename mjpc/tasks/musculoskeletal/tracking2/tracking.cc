...
std::string Tracking2::XmlPath() const {
  return GetModelPath("musculoskeletal/tracking2/task.xml");
}
std::string Tracking2::Name() const { return "MS Track2"; }
...
// ----------------------------------------------------------------
void Tracking2::ResidualFn::Residual(const mjModel *model, const mjData *data,
