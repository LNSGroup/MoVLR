...
constexpr double kFps = 20;

constexpr int kMotionLengths[] = {
    188,  // Jump - CMU-CMU-02-02_04
...
std::string Tracking4::XmlPath() const {
  return GetModelPath("musculoskeletal/tracking4/task.xml");
}
std::string Tracking4::Name() const { return "MS Track4"; }
...
// ----------------------------------------------------------------
void Tracking4::ResidualFn::Residual(const mjModel *model, const mjData *data,
...
// ----------------------------------------------------------------------------
void Tracking4::TransitionLocked(mjModel *model, mjData *d) {
  // get motion start index
