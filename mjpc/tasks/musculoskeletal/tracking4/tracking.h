...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_TRACKING4_TASK_H_
#define MJPC_TASKS_MUSCULOSKELETAL_TRACKING4_TASK_H_
...
class Tracking4 : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Tracking4* task, int current_mode = 0,
   ...
   private:
    friend class Tracking4;
    int current_mode_;
    double reference_time_;
  };

  Tracking4() : residual_(this) {}
