...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_MUSCULOSKELETAL_Swim_H_
#define MJPC_TASKS_MUSCULOSKELETAL_MUSCULOSKELETAL_Swim_H_
...
class Swim : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Swim* task) : mjpc::BaseResidualFn(task) {}
