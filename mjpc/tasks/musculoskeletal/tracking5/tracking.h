...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_TRACKING5_TASK_H_
#define MJPC_TASKS_MUSCULOSKELETAL_TRACKING5_TASK_H_
...
class Tracking5 : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Tracking5* task, int current_mode = 0,
   ...
   private:
    friend class Tracking5;
    int current_mode_;
    double reference_time_;
  };

  Tracking5() : residual_(this) {}
