...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_TRACKING3_TASK_H_
#define MJPC_TASKS_MUSCULOSKELETAL_TRACKING3_TASK_H_
...
class Tracking3 : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Tracking3* task, int current_mode = 0,
   ...
   private:
    friend class Tracking3;
    int current_mode_;
    double reference_time_;
  };

  Tracking3() : residual_(this) {}
