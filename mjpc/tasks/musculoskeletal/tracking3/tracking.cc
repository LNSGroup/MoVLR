...
std::string Tracking3::XmlPath() const {
  return GetModelPath("musculoskeletal/tracking3/task.xml");
}
std::string Tracking3::Name() const { return "MS Track3"; }
...
// ----------------------------------------------------------------
void Tracking3::ResidualFn::Residual(const mjModel *model, const mjData *data,
...
// ----------------------------------------------------------------------------
void Tracking3::TransitionLocked(mjModel *model, mjData *d) {
  // get motion start index
