...
std::string WalkGym::XmlPath() const {
  return GetModelPath("musculoskeletal/walk_gym/task.xml");
}
std::string WalkGym::Name() const { return "MS WalkGym"; }
...
// -------------------------------------------------------------
void WalkGym::ResidualFn::Residual(const mjModel* model, const mjData* data,
...
void WalkGym::TransitionLocked(mjModel* model, mjData* data) {
