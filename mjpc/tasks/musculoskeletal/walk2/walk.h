...
#ifndef MJPC_TASKS_MUSCULOSKELETAL_MUSCULOSKELETAL_Walk2_H_
#define MJPC_TASKS_MUSCULOSKELETAL_MUSCULOSKELETAL_Walk2_H_
...
class Walk2 : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Walk2* task) : mjpc::BaseResidualFn(task) {}
