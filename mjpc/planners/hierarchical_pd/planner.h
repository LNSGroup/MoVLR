...
#ifndef MJPC_PLANNERS_HIERARCHICAL_PD_PLANNER_H_
#define MJPC_PLANNERS_HIERARCHICAL_PD_PLANNER_H_
...
class HierarchicalPDPlanner : public RankedPlanner {
 public:
  // constructor
  HierarchicalPDPlanner() = default;

  // destructor
  ~HierarchicalPDPlanner() override = default;
  ...
  void SyncPolicyData(HierarchicalPDPolicy policy, mjData* src);
