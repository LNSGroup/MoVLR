...
#ifndef MJPC_PLANNERS_HIERARCHICAL_CROSS_ENTROPY_PLANNER_H_
#define MJPC_PLANNERS_HIERARCHICAL_CROSS_ENTROPY_PLANNER_H_
...
class HierarchicalCrossEntropyPlanner : public Planner {
 public:
  // constructor
  HierarchicalCrossEntropyPlanner() = default;

  // destructor
  ~HierarchicalCrossEntropyPlanner() override = default;
