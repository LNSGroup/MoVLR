...
class State {
 public:
  ...
  void Set(const mjModel* model, const double* qpos, const double* qvel,
           ...
           const double* userdata, double time, const double* actuator_length, 
           const double* actuator_velocity, const double* xfrc_applied);
  ...
  void SetPerturb(const mjModel* model, const double* xfrc_applied);
